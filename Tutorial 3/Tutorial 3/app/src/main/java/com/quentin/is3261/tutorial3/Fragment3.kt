...
class Fragment3 : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val btnInFragment3 = view.findViewById<Button>(R.id.activity_interface_toast_butt)
        btnInFragment3.setOnClickListener {
            onButtonPressed("This Toast message is from Fragment 4 !")
        }
        return view
    }
