...
class DBHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    companion object {
        ...
        private val SQL_CREATE_ENTRIES =
                "CREATE TABLE " + TableInfo.TABLE_NAME + " (" +
                        ...
                        TableInfo.COLUMN_NUMBEROFSTUDENTS + " TEXT," +
    ...
    fun insertCourse(course: DataRecord): Boolean {
        ...
        values.put(TableInfo.COLUMN_NUMBEROFSTUDENTS, course.numberOfStudents)
    ...
    fun readCourse(courseCode: String): ArrayList<DataRecord> {
        ...
        try {
            cursor = db.rawQuery("select * from " +
                    ...
                    TableInfo.COLUMN_NUMBEROFSTUDENTS + "=" + courseCode + "", null)
        ...
        if (cursor!!.moveToFirst()) {
            while (cursor.isAfterLast == false) {
                numberOfStudents = cursor.getInt(cursor.getColumnIndex(TableInfo.COLUMN_NUMBEROFSTUDENTS))
